        ...
        if dt.find(error) == -1 :
            ...
            if s > 0 :
                ...
                if(c1==1):
                    ...
                    # data_inst_granted['TOTAL_PAID_INST'] = data_inst_granted['TOTAL_PAID_INST'].apply(lambda x : 0 if x == '' else x).astype(float)
                    # data_inst_granted['DAYS_PAYMENT_DELAY_MAX'] = data_inst_granted['DAYS_PAYMENT_DELAY_MAX'].apply(lambda x : 0 if x == '' else x).astype(float)
                    ...
                    data_inst_granted['MaxNrOfDaysOfPaymentDelay']=data_inst_granted['MaxNrOfDaysOfPaymentDelay'].apply(lambda x : 0 if x == '' else x).astype(float)
                    ...
                    if(data_inst_granted['TotalAmount'].sum() > 0):
                ...
                if (c2==1):
                    ...
                    data_card_granted['MaxNrOfDaysOfPaymentDelay']=data_card_granted['MaxNrOfDaysOfPaymentDelay'].apply(lambda x : 0 if x == '' else x).astype(float)                                                  
